...
5. Enter the values in all the fields of a row and click on <b>Submit</b>.
6. The correctness of the entered answer is displayed in <b>Observations</b>.
...
8. Repeat this process until all the rows are filled and the algorithm is complete when a success message displaying the GCD appears in <b>Observations</b>.
...
4. If the correct polynomial is selected, the element(s) and minimal polynomial turn green indicating that it is a correct match. The correct answer message is displayed in <b>Observations.</b>
5. If the answer is wrong, the wrong answer message is displayed in <b>Observations</b>. Try again by selecting another minimal polynomial.
